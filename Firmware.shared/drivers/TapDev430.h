...
public:
	...
	virtual void WriteByte(address_t address, uint8_t data) override;
	// Writes a set of bytes
	virtual void WriteBytes(address_t address, const uint8_t *buf, uint32_t byte_count) override;
