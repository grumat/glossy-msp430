...
/// Pin for green LED
typedef GpioTemplate<PB, 9, kOutput50MHz, kPushPull, kHigh> GREEN_LED;
...
typedef GpioPortTemplate <PB
	...
	, PinUnused<14>		///< SPI2_MISO (reserved for SBW)
	, PinUnused<15>		///< SPI2_MOSI (reserved for SBW)
> PORTB;
