...
namespace MkChipInfoDbV2
{
	...
	{
		static void Mk53_0(SqliteCommand cmd)
		{
			cmd.ExecuteNonQuery();
			cmd.CommandText = @"
			...
			cmd.CommandText = @"
				...
				WHERE
					...
					AND Memories2.BlockId IN ('kBlkBootCode_1', 'kBlkIrVec_0', 'kBlkMain_75', 'kBlkPeripheral16bit_2', 'kBlkRam_22')
				";
			cmd.ExecuteNonQuery();
		}
	}
