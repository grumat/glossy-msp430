...
> do exactly that (entries below). *(The F2618 sample is dead — marked "Bad
...
>
> ⚠ **Doc note (now resolved — see F1611 below):** the wiring guide used to
> describe the STLinkV2 path as "SBW-only." That is **disproven** by the F1611
> JTAG success below — the STLinkV2 maps all four JTAG signals (JTCK/JTDO/JTDI/JTMS
