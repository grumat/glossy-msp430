...
public:
	...
	static constexpr GpioSpeed kMode_ = kInput;
	...
	static constexpr uint32_t kInitialLevel_ = Level::kLow;
...
**		typedef GpioTemplate<Gpio::PA, 5, kOutput50MHz, GpioMode::kPushPull, Level::kHigh> MY_SPI_CLK;
...
template<
	...
	, const GpioSpeed kMode = kInput			///< Mode to configure the port
...
>
class FloatingPin : public GpioTemplate<kPort, kPin, kInput, GpioMode::kFloating>
{
};
...
template <
	...
	, const uint8_t kPin
>
class InputPullUpPin : public GpioTemplate<kPort, kPin, kInput, GpioMode::kInputPushPull, Level::kHigh>
{
};
...
template <
	...
	, const uint8_t kPin
>
class InputPullDownPin : public GpioTemplate<kPort, kPin, kInput, GpioMode::kInputPushPull, Level::kLow>
{
};
...
\code{.cpp}
/// Pin for green LED
typedef GpioTemplate<Gpio::PA, 0, GpioSpeed::kOutput2MHzkOutput2MHz, GpioMode::kPushPull, Level::kHigh> GREEN_LED;
...
typedef GpioTemplate<Gpio::PA, 0, kInput, GpioMode::kAnalog> ADC12_IN0;
/// A default configuration for ADC12 IN1 on PA1
typedef GpioTemplate<Gpio::PA, 1, kInput, GpioMode::kAnalog> ADC12_IN1;
/// A default configuration for ADC12 IN2 on PA2
typedef GpioTemplate<Gpio::PA, 2, kInput, GpioMode::kAnalog> ADC12_IN2;
/// A default configuration for ADC12 IN3 on PA3
typedef GpioTemplate<Gpio::PA, 3, kInput, GpioMode::kAnalog> ADC12_IN3;
/// A default configuration for ADC12 IN4 on PA4
typedef GpioTemplate<Gpio::PA, 4, kInput, GpioMode::kAnalog> ADC12_IN4;
/// A default configuration for ADC12 IN5 on PA5
typedef GpioTemplate<Gpio::PA, 5, kInput, GpioMode::kAnalog> ADC12_IN5;
/// A default configuration for ADC12 IN6 on PA6
typedef GpioTemplate<Gpio::PA, 6, kInput, GpioMode::kAnalog> ADC12_IN6;
/// A default configuration for ADC12 IN7 on PA7
typedef GpioTemplate<Gpio::PA, 7, kInput, GpioMode::kAnalog> ADC12_IN7;
/// A default configuration for ADC12 IN8 on PB0
typedef GpioTemplate<Gpio::PB, 0, kInput, GpioMode::kAnalog> ADC12_IN8;
/// A default configuration for ADC12 IN9 on PB1
typedef GpioTemplate<Gpio::PB, 1, kInput, GpioMode::kAnalog> ADC12_IN9;
/// A default configuration for ADC12 IN10 on PC0
typedef GpioTemplate<Gpio::PC, 0, kInput, GpioMode::kAnalog> ADC12_IN10;
/// A default configuration for ADC12 IN11 on PC1
typedef GpioTemplate<Gpio::PC, 1, kInput, GpioMode::kAnalog> ADC12_IN11;
/// A default configuration for ADC12 IN12 on PC2
typedef GpioTemplate<Gpio::PC, 2, kInput, GpioMode::kAnalog> ADC12_IN12;
/// A default configuration for ADC12 IN13 on PC3
typedef GpioTemplate<Gpio::PC, 3, kInput, GpioMode::kAnalog> ADC12_IN13;
/// A default configuration for ADC12 IN14 on PC4
typedef GpioTemplate<Gpio::PC, 4, kInput, GpioMode::kAnalog> ADC12_IN14;
/// A default configuration for ADC12 IN15 on PC5
typedef GpioTemplate<Gpio::PC, 5, kInput, GpioMode::kAnalog> ADC12_IN15;
...
typedef GpioTemplate<Gpio::PA, 11, kInput, GpioMode::kInputPushPull, Level::kHigh, AfCan_PA11_12>				CAN_RX_PA11;
/// A default configuration for CAN/TX on PA12 pin
typedef GpioTemplate<Gpio::PA, 12, kOutput50MHz, GpioMode::kAlternateOpenDrain, Level::kLow, AfCan_PA11_12>	CAN_TX_PA12;

//////////////////////////////////////////////////////////////////////
// CAN - Configuration 2 (cannot mix pins between configuration)
//////////////////////////////////////////////////////////////////////
/// A default configuration for CAN/RX on PB8 pin
typedef GpioTemplate<Gpio::PB, 8, kInput, GpioMode::kInputPushPull, Level::kHigh, AfCan_PB8_9>				CAN_RX_PB8;
/// A default configuration for CAN/TX on PB9 pin
typedef GpioTemplate<Gpio::PB, 9, kOutput50MHz, GpioMode::kAlternateOpenDrain, Level::kLow, AfCan_PB8_9>	CAN_TX_PB9;

//////////////////////////////////////////////////////////////////////
// CAN - Configuration 3 (cannot mix pins between configuration)
//////////////////////////////////////////////////////////////////////
/// A default configuration for CAN/RX on PD0 pin
typedef GpioTemplate<Gpio::PD, 0, kInput, GpioMode::kInputPushPull, Level::kHigh, AfCan_PD0_1>				CAN_RX_PD0;
/// A default configuration for CAN/TX on PD1 pin
typedef GpioTemplate<Gpio::PD, 1, kOutput50MHz, GpioMode::kAlternateOpenDrain, Level::kLow, AfCan_PD0_1>	CAN_TX_PD1;
...
typedef GpioTemplate<Gpio::PB, 6, kOutput50MHz, GpioMode::kAlternateOpenDrain, Level::kLow, AfI2C1_PB6_7>	I2C1_SCL_PB6;
/// A default configuration to map I2C1 SDA on PB7 pin
typedef GpioTemplate<Gpio::PB, 7, kOutput50MHz, GpioMode::kAlternateOpenDrain, Level::kLow, AfI2C1_PB6_7>	I2C1_SDA_PB7;
// I2C1 - Configuration 2
/// A default configuration to map I2C1 SCL on PB8 pin
typedef GpioTemplate<Gpio::PB, 8, kOutput50MHz, GpioMode::kAlternateOpenDrain, Level::kLow, AfI2C1_PB8_9>	I2C1_SCL_PB8;
/// A default configuration to map I2C1 SDA on PB9 pin
typedef GpioTemplate<Gpio::PB, 9, kOutput50MHz, GpioMode::kAlternateOpenDrain, Level::kLow, AfI2C1_PB8_9>	I2C1_SDA_PB9;
// I2C1 - Configuration 1 & 2
/// A default configuration to map I2C1 SMBAI on PB5 pin
typedef GpioTemplate<Gpio::PB, 5, kOutput50MHz, GpioMode::kAlternateOpenDrain, Level::kLow, AfNoRemap>		I2C1_SMBAI_PB5;

//////////////////////////////////////////////////////////////////////
// I2C2
//////////////////////////////////////////////////////////////////////
/// A default configuration to map I2C2 SCL on PB10 pin
typedef GpioTemplate<Gpio::PB, 10, kOutput50MHz, GpioMode::kAlternateOpenDrain, Level::kLow, AfNoRemap>	I2C2_SCL_PB10;
/// A default configuration to map I2C2 SDA on PB11 pin
typedef GpioTemplate<Gpio::PB, 11, kOutput50MHz, GpioMode::kAlternateOpenDrain, Level::kLow, AfNoRemap>	I2C2_SDA_PB11;
/// A default configuration to map I2C2 SMBAI on PB12 pin
typedef GpioTemplate<Gpio::PB, 12, kOutput50MHz, GpioMode::kAlternateOpenDrain, Level::kLow, AfNoRemap>	I2C2_SMBAI_PB12;

//////////////////////////////////////////////////////////////////////
// SPI1 - Configuration 1
//////////////////////////////////////////////////////////////////////
/// A default configuration to map SPI1 NSS on PA4 pin (master)
typedef GpioTemplate<Gpio::PA, 4, kOutput50MHz, GpioMode::kAlternateOpenDrain, Level::kHigh, AfSpi1_PA4_5_6_7>	SPI1_NSS_PA4;
/// A default configuration to map SPI1 NSS on PA4 pin (slave)
typedef GpioTemplate<Gpio::PA, 4, kInput, GpioMode::kInputPushPull, Level::kHigh, AfSpi1_PA4_5_6_7>			SPI1_NSS_PA4_SLAVE;
/// A default configuration to map SPI1 SCK on PA5 pin
typedef GpioTemplate<Gpio::PA, 5, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfSpi1_PA4_5_6_7>	SPI1_SCK_PA5;
/// A default configuration to map SPI1 MISO on PA6 pin
typedef GpioTemplate<Gpio::PA, 6, kInput, GpioMode::kInputPushPull, Level::kHigh, AfSpi1_PA4_5_6_7>			SPI1_MISO_PA6;
/// A default configuration to map SPI1 MOSI on PA7 pin
typedef GpioTemplate<Gpio::PA, 7, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kHigh, AfSpi1_PA4_5_6_7>	SPI1_MOSI_PA7;
// SPI1 - Configuration 2
/// A default configuration to map SPI1 NSS on PA15 pin (master)
typedef GpioTemplate<Gpio::PA, 15, kOutput50MHz, GpioMode::kAlternateOpenDrain, Level::kHigh, AfSpi1_PA15_PB3_4_5>	SPI1_NSS_PA15;
/// A default configuration to map SPI1 NSS on PA15 pin (slave)
typedef GpioTemplate<Gpio::PA, 15, kInput, GpioMode::kInputPushPull, Level::kHigh, AfSpi1_PA15_PB3_4_5>			SPI1_NSS_PA15_SLAVE;
/// A default configuration to map SPI1 SCK on PB3 pin
typedef GpioTemplate<Gpio::PB, 3, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfSpi1_PA15_PB3_4_5>	SPI1_SCK_PB3;
/// A default configuration to map SPI1 MISO on PB4 pin
typedef GpioTemplate<Gpio::PB, 4, kInput, GpioMode::kInputPushPull, Level::kHigh, AfSpi1_PA15_PB3_4_5>				SPI1_MISO_PB4;
/// A default configuration to map SPI1 MOSI on PB5 pin
typedef GpioTemplate<Gpio::PB, 5, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kHigh, AfSpi1_PA15_PB3_4_5>	SPI1_MOSI_PB5;

//////////////////////////////////////////////////////////////////////
// SPI2
//////////////////////////////////////////////////////////////////////
/// A default configuration to map SPI2 NSS on PB12 pin (master)
typedef GpioTemplate<Gpio::PB, 12, kOutput50MHz, GpioMode::kAlternateOpenDrain, Level::kHigh, AfNoRemap>	SPI2_NSS_PB12;
/// A default configuration to map SPI2 NSS on PB12 pin (slave)
typedef GpioTemplate<Gpio::PB, 12, kInput, GpioMode::kInputPushPull, Level::kHigh, AfNoRemap>				SPI2_NSS_PB12_SLAVE;
/// A default configuration to map SPI2 SCK on PB13 pin
typedef GpioTemplate<Gpio::PB, 13, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfNoRemap>		SPI2_SCK_PB13;
/// A default configuration to map SPI2 MISO on PB14 pin
typedef GpioTemplate<Gpio::PB, 14, kInput, GpioMode::kInputPushPull, Level::kHigh, AfNoRemap>				SPI2_MISO_PB14;
/// A default configuration to map SPI2 MOSI on PB15 pin
typedef GpioTemplate<Gpio::PB, 15, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kHigh, AfNoRemap>	SPI2_MOSI_PB15;
...
typedef TIM1_ETR_PA12<kInput, GpioMode::kFloating, Level::kLow>		TIM1_ETR_PA12_IN;
...
typedef TIM1_CH1_PA8<kOutput50MHz, GpioMode::kAlternatePushPull>	TIM1_CH1_PA8_OUT;
/// A default configuration to map TIM1 CH1 on PA8 pin (input)
typedef TIM1_CH1_PA8<kInput, GpioMode::kFloating>					TIM1_CH1_PA8_IN;
...
typedef TIM1_CH2_PA9<kOutput50MHz, GpioMode::kAlternatePushPull>	TIM1_CH2_PA9_OUT;
/// A default configuration to map TIM1 CH2 on PA9 pin (input)
typedef TIM1_CH2_PA9<kInput, GpioMode::kFloating>					TIM1_CH2_PA9_IN;
...
typedef TIM1_CH3_PA10<kOutput50MHz, GpioMode::kAlternatePushPull>	TIM1_CH3_PA10_OUT;
/// A default configuration to map TIM1 CH3 on PA10 pin (input)
typedef TIM1_CH3_PA10<kInput, GpioMode::kFloating>				TIM1_CH3_PA10_IN;
...
typedef TIM1_CH4_PA11<kOutput50MHz, GpioMode::kAlternatePushPull>	TIM1_CH4_PA11_OUT;
/// A default configuration to map TIM1 CH4 on PA11 pin (input)
typedef TIM1_CH4_PA11<kInput, GpioMode::kFloating>				TIM1_CH4_PA11_IN;
...
typedef TIM1_BKIN_PB12<kInput, GpioMode::kFloating>				TIM1_BKIN_PB12_IN;
...
typedef TIM1_CH1N_PB13<kOutput50MHz, GpioMode::kAlternatePushPull>	TIM1_CH1N_PB13_OUT;
...
typedef TIM1_CH2N_PB14<kOutput50MHz, GpioMode::kAlternatePushPull>	TIM1_CH2N_PB14_OUT;
...
typedef TIM1_CH3N_PB15<kOutput50MHz, GpioMode::kAlternatePushPull>	TIM1_CH3N_PB15_OUT;
...
/// A default configuration to map TIM1 ETR on PA12 pin (input)
typedef TIM1_ETR_PA12_P<kInput, GpioMode::kFloating>					TIM1_ETR_PA12_IN_CFG2;

/// A generic configuration to map TIM1 CH1 on PA8 pin
template<const GpioSpeed kMode, const GpioMode kConf, const Level LVL = Level::kLow>
struct TIM1_CH1_PA8_P : GpioTemplate<Gpio::PA, 8, kMode, kConf, LVL, AfTim1_PA12_8_9_10_11_6_7_PB0_1> {};
/// A default configuration to map TIM1 CH1 on PA8 pin (output)
typedef TIM1_CH1_PA8_P<kOutput50MHz, GpioMode::kAlternatePushPull>	TIM1_CH1_PA8_OUT_CFG2;
/// A default configuration to map TIM1 CH1 on PA8 pin (input)
typedef TIM1_CH1_PA8_P<kInput, GpioMode::kFloating>					TIM1_CH1_PA8_IN_CFG2;

/// A generic configuration to map TIM1 CH2 on PA9 pin
template<const GpioSpeed kMode, const GpioMode kConf, const Level LVL = Level::kLow>
struct TIM1_CH2_PA9_P : GpioTemplate<Gpio::PA, 9, kMode, kConf, LVL, AfTim1_PA12_8_9_10_11_6_7_PB0_1> {};
/// A default configuration to map TIM1 CH2 on PA9 pin (output)
typedef TIM1_CH2_PA9_P<kOutput50MHz, GpioMode::kAlternatePushPull>	TIM1_CH2_PA9_OUT_CFG2;
/// A default configuration to map TIM1 CH2 on PA9 pin (input)
typedef TIM1_CH2_PA9_P<kInput, GpioMode::kFloating>					TIM1_CH2_PA9_IN_CFG2;

/// A generic configuration to map TIM1 CH3 on PA10 pin
template<const GpioSpeed kMode, const GpioMode kConf, const Level LVL = Level::kLow>
struct TIM1_CH3_PA10_P : GpioTemplate<Gpio::PA, 10, kMode, kConf, LVL, AfTim1_PA12_8_9_10_11_6_7_PB0_1> {};
/// A default configuration to map TIM1 CH3 on PA10 pin (output)
typedef TIM1_CH3_PA10_P<kOutput50MHz, GpioMode::kAlternatePushPull>	TIM1_CH3_PA10_OUT_CFG2;
/// A default configuration to map TIM1 CH3 on PA10 pin (input)
typedef TIM1_CH3_PA10_P<kInput, GpioMode::kFloating>					TIM1_CH3_PA10_IN_CFG2;

/// A generic configuration to map TIM1 CH4 on PA11 pin
template<const GpioSpeed kMode, const GpioMode kConf, const Level LVL = Level::kLow>
struct TIM1_CH4_PA11_P : GpioTemplate<Gpio::PA, 11, kMode, kConf, LVL, AfTim1_PA12_8_9_10_11_6_7_PB0_1> {};
/// A default configuration to map TIM1 CH4 on PA11 pin (output)
typedef TIM1_CH4_PA11_P<kOutput50MHz, GpioMode::kAlternatePushPull>	TIM1_CH4_PA11_OUT_CFG2;
/// A default configuration to map TIM1 CH4 on PA11 pin (input)
typedef TIM1_CH4_PA11_P<kInput, GpioMode::kFloating>					TIM1_CH4_PA11_IN_CFG2;
...
typedef TIM1_BKIN_PA6_P<kInput, GpioMode::kFloating>					TIM1_BKIN_PA6_IN_CFG2;
...
typedef TIM1_CH1N_PA7_P<kOutput50MHz, GpioMode::kAlternatePushPull>	TIM1_CH1N_PA7_OUT_CFG2;
...
typedef TIM1_CH2N_PB0_P<kOutput50MHz, GpioMode::kAlternatePushPull>	TIM1_CH2N_PB0_OUT_CFG2;
...
typedef TIM1_CH3N_PB1_P<kOutput50MHz, GpioMode::kAlternatePushPull>	TIM1_CH3N_PB1_OUT_CFG2;
...
typedef TIM1_ETR_PE7<kInput, GpioMode::kFloating>						TIM1_ETR_PE7_IN_CFG3;
...
typedef TIM1_CH1_PE9<kOutput50MHz, GpioMode::kAlternatePushPull>		TIM1_CH1_PE9_OUT_CFG3;
/// A default configuration to map TIM1 CH1 on PE9 pin (input)
typedef TIM1_CH1_PE9<kInput, GpioMode::kFloating>						TIM1_CH1_PE9_IN_CFG3;
...
typedef TIM1_CH2_PE11<kOutput50MHz, GpioMode::kAlternatePushPull>		TIM1_CH2_PE11_OUT_CFG3;
/// A default configuration to map TIM1 CH2 on PE11 pin (input)
typedef TIM1_CH2_PE11<kInput, GpioMode::kFloating>					TIM1_CH2_PE11_IN_CFG3;
...
typedef TIM1_CH3_PE13<kOutput50MHz, GpioMode::kAlternatePushPull>		TIM1_CH3_PE13_OUT_CFG3;
/// A default configuration to map TIM1 CH3 on PE13 pin (input)
typedef TIM1_CH3_PE13<kInput, GpioMode::kFloating>					TIM1_CH3_PE13_IN_CFG3;
...
typedef TIM1_CH4_PE14<kOutput50MHz, GpioMode::kAlternatePushPull>		TIM1_CH4_PE14_OUT_CFG3;
/// A default configuration to map TIM1 CH4 on PE14 pin (input)
typedef TIM1_CH4_PE14<kInput, GpioMode::kFloating>					TIM1_CH4_PE14_IN_CFG3;
...
typedef TIM1_BKIN_PE15<kInput, GpioMode::kFloating>					TIM1_BKIN_PE15_IN_CFG3;
...
typedef TIM1_CH1N_PE8<kOutput50MHz, GpioMode::kAlternatePushPull>		TIM1_CH1N_PE8_OUT_CFG3;
...
typedef TIM1_CH2N_PE10<kOutput50MHz, GpioMode::kAlternatePushPull>	TIM1_CH2N_PE10_OUT_CFG3;
...
typedef TIM1_CH3N_PE12<kOutput50MHz, GpioMode::kAlternatePushPull>	TIM1_CH3N_PE12_OUT_CFG3;
...
typedef TIM2_CH1_PA0<kOutput50MHz, GpioMode::kAlternatePushPull>		TIM2_CH1_PA0_OUT;
/// A default configuration to map TIM1 CH1 on PA0 pin (input)
typedef TIM2_CH1_PA0<kInput, GpioMode::kFloating>						TIM2_CH1_PA0_IN;
/// A default configuration to map TIM1 CH1 on PA0 pin (input)
typedef TIM2_CH1_PA0<kInput, GpioMode::kFloating>						TIM2_ETR_PA0_IN;
...
typedef TIM2_CH2_PA1<kOutput50MHz, GpioMode::kAlternatePushPull>		TIM2_CH2_PA1_OUT;
/// A default configuration to map TIM1 CH2 on PA1 pin (input)
typedef TIM2_CH2_PA1<kInput, GpioMode::kFloating>						TIM2_CH2_PA1_IN;
...
typedef TIM2_CH3_PA2<kOutput50MHz, GpioMode::kAlternatePushPull>		TIM2_CH3_PA2_OUT;
/// A default configuration to map TIM1 CH3 on PA2 pin (input)
typedef TIM2_CH3_PA2<kInput, GpioMode::kFloating>						TIM2_CH3_PA2_IN;
...
typedef TIM2_CH4_PA3<kOutput50MHz, GpioMode::kAlternatePushPull>		TIM2_CH4_PA3_OUT;
/// A default configuration to map TIM1 CH4 on PA3 pin (input)
typedef TIM2_CH4_PA3<kInput, GpioMode::kFloating>						TIM2_CH4_PA3_IN;
...
typedef TIM2_CH1_PA15_P<kOutput50MHz, GpioMode::kAlternatePushPull>	TIM2_CH1_PA15_OUT_CFG2;
/// A default configuration to map TIM2 CH1 on PA15 pin (partial remap/config 2 - input)
typedef TIM2_CH1_PA15_P<kInput, GpioMode::kFloating>					TIM2_CH1_PA15_IN_CFG2;
/// A default configuration to map TIM2 ETR on PA15 pin (partial remap/config 2 - input)
typedef TIM2_CH1_PA15_P<kInput, GpioMode::kFloating>					TIM2_ETR_PA15_IN_CFG2;
...
typedef TIM2_CH2_PB3_P<kOutput50MHz, GpioMode::kAlternatePushPull>	TIM2_CH2_PB3_OUT_CFG2;
/// A default configuration to map TIM2 CH2 on PB3 pin (partial remap/config 2 - input)
typedef TIM2_CH2_PB3_P<kInput, GpioMode::kFloating>					TIM2_CH2_PB3_IN_CFG2;
...
typedef TIM2_CH3_PA2_P<kOutput50MHz, GpioMode::kAlternatePushPull>	TIM2_CH3_PA2_OUT_CFG2;
/// A default configuration to map TIM2 CH3 on PA2 pin (partial remap/config 2 - input)
typedef TIM2_CH3_PA2_P<kInput, GpioMode::kFloating>					TIM2_CH3_PA2_IN_CFG2;
...
typedef TIM2_CH4_PA3_P<kOutput50MHz, GpioMode::kAlternatePushPull>	TIM2_CH4_PA3_OUT_CFG2;
/// A default configuration to map TIM2 CH4 on PA3 pin (partial remap/config 2 - input)
typedef TIM2_CH4_PA3_P<kInput, GpioMode::kFloating>					TIM2_CH4_PA3_IN_CFG2;
...
typedef TIM2_CH1_PA0_P<kOutput50MHz, GpioMode::kAlternatePushPull>	TIM2_CH1_PA0_OUT_CFG3;
/// A default configuration to map TIM2 CH1 on PA0 pin (partial remap/config 3 - input)
typedef TIM2_CH1_PA0_P<kInput, GpioMode::kFloating>					TIM2_CH1_PA0_IN_CFG3;
/// A default configuration to map TIM2 ETR on PA0 pin (partial remap/config 3 - input)
typedef TIM2_CH1_PA0_P<kInput, GpioMode::kFloating>					TIM2_ETR_PA0_IN_CFG3;
...
typedef TIM2_CH2_PA1_P<kOutput50MHz, GpioMode::kAlternatePushPull>	TIM2_CH2_PA1_OUT_CFG3;
/// A default configuration to map TIM2 CH2 on PA1 pin (partial remap/config 3 - input)
typedef TIM2_CH2_PA1_P<kInput, GpioMode::kFloating>					TIM2_CH2_PA1_IN_CFG3;
...
typedef TIM2_CH3_PB10_P<kOutput50MHz, GpioMode::kAlternatePushPull>	TIM2_CH3_PB10_OUT_CFG3;
/// A default configuration to map TIM2 CH3 on PA10 pin (partial remap/config 3 - input)
typedef TIM2_CH3_PB10_P<kInput, GpioMode::kFloating>					TIM2_CH3_PB10_IN_CFG3;
...
typedef TIM2_CH4_PB11_P<kOutput50MHz, GpioMode::kAlternatePushPull>	TIM2_CH4_PB11_OUT_CFG3;
/// A default configuration to map TIM2 CH3 on PB11 pin (partial remap/config 3 - input)
typedef TIM2_CH4_PB11_P<kInput, GpioMode::kFloating>					TIM2_CH4_PB11_IN_CFG3;
...
typedef TIM2_CH1_PA15<kOutput50MHz, GpioMode::kAlternatePushPull>	TIM2_CH1_PA15_OUT_CFG4;
/// A default configuration to map TIM2 CH1 on PA15 pin (full remap/config 4 - input)
typedef TIM2_CH1_PA15<kInput, GpioMode::kFloating>				TIM2_CH1_PA15_IN_CFG4;
/// A default configuration to map TIM2 ETR on PA15 pin (full remap/config 4 - input)
typedef TIM2_CH1_PA15<kInput, GpioMode::kFloating>				TIM2_ETR_PA15_IN_CFG4;
...
typedef TIM2_CH2_PB3<kOutput50MHz, GpioMode::kAlternatePushPull>	TIM2_CH2_PB3_OUT_CFG4;
/// A default configuration to map TIM2 CH2 on PB3 pin (full remap/config 4 - input)
typedef TIM2_CH2_PB3<kInput, GpioMode::kFloating>					TIM2_CH2_PB3_IN_CFG4;
...
typedef TIM2_CH3_PB10<kOutput50MHz, GpioMode::kAlternatePushPull>	TIM2_CH3_PB10_OUT_CFG4;
/// A default configuration to map TIM2 CH3 on PB10 pin (full remap/config 4 - input)
typedef TIM2_CH3_PB10<kInput, GpioMode::kFloating>				TIM2_CH3_PB10_IN_CFG4;
...
typedef TIM2_CH4_PB11<kOutput50MHz, GpioMode::kAlternatePushPull>	TIM2_CH4_PB11_OUT_CFG4;
/// A default configuration to map TIM2 CH4 on PB11 pin (full remap/config 4 - input)
typedef TIM2_CH4_PB11<kInput, GpioMode::kFloating>				TIM2_CH4_PB11_IN_CFG4;
...
typedef TIM3_CH1_PA6<kOutput50MHz, GpioMode::kAlternatePushPull>	TIM3_CH1_PA6_OUT;
/// A default configuration to map TIM3 CH1 on PA6 pin (input)
typedef TIM3_CH1_PA6<kInput, GpioMode::kFloating>					TIM3_CH1_PA6_IN;
...
typedef TIM3_CH2_PA7<kOutput50MHz, GpioMode::kAlternatePushPull>	TIM3_CH2_PA7_OUT;
/// A default configuration to map TIM3 CH2 on PA7 pin (input)
typedef TIM3_CH2_PA7<kInput, GpioMode::kFloating>					TIM3_CH2_PA7_IN;
...
typedef TIM3_CH3_PB0<kOutput50MHz, GpioMode::kAlternatePushPull>	TIM3_CH3_PB0_OUT;
/// A default configuration to map TIM3 CH3 on PB0 pin (input)
typedef TIM3_CH3_PB0<kInput, GpioMode::kFloating>					TIM3_CH3_PB0_IN;
...
typedef TIM3_CH4_PB1<kOutput50MHz, GpioMode::kAlternatePushPull>	TIM3_CH4_PB1_OUT;
/// A default configuration to map TIM3 CH4 on PB1 pin (input)
typedef TIM3_CH4_PB1<kInput, GpioMode::kFloating>					TIM3_CH4_PB1_IN;
...
typedef TIM3_CH1_PB4_P<kOutput50MHz, GpioMode::kAlternatePushPull>	TIM3_CH1_PB4_OUT_CFG2;
/// A default configuration to map TIM3 CH1 on PB4 pin (partial remap/config 2 - input)
typedef TIM3_CH1_PB4_P<kInput, GpioMode::kFloating>					TIM3_CH1_PB4_IN_CFG2;
...
typedef TIM3_CH2_PB5_P<kOutput50MHz, GpioMode::kAlternatePushPull>	TIM3_CH2_PB5_OUT_CFG2;
/// A default configuration to map TIM3 CH2 on PB5 pin (partial remap/config 2 - input)
typedef TIM3_CH2_PB5_P<kInput, GpioMode::kFloating>					TIM3_CH2_PB5_IN_CFG2;
...
typedef TIM3_CH3_PB0_P<kOutput50MHz, GpioMode::kAlternatePushPull>	TIM3_CH3_PB0_OUT_CFG2;
/// A default configuration to map TIM3 CH3 on PB0 pin (partial remap/config 2 - input)
typedef TIM3_CH3_PB0_P<kInput, GpioMode::kFloating>					TIM3_CH3_PB0_IN_CFG2;
...
typedef TIM3_CH4_PB1_P<kOutput50MHz, GpioMode::kAlternatePushPull>	TIM3_CH4_PB1_OUT_CFG2;
/// A default configuration to map TIM3 CH4 on PB1 pin (partial remap/config 2 - input)
typedef TIM3_CH4_PB1_P<kInput, GpioMode::kFloating>					TIM3_CH4_PB1_IN_CFG2;
...
typedef TIM3_CH1_PC6<kOutput50MHz, GpioMode::kAlternatePushPull>		TIM3_CH1_PC6_OUT_CFG3;
/// A default configuration to map TIM3 CH1 on PC6 pin (full remap/config 3 - input)
typedef TIM3_CH1_PC6<kInput, GpioMode::kFloating>						TIM3_CH1_PC6_IN_CFG3;
...
typedef TIM3_CH2_PC7<kOutput50MHz, GpioMode::kAlternatePushPull>		TIM3_CH2_PC7_OUT_CFG3;
/// A default configuration to map TIM3 CH2 on PC7 pin (full remap/config 3 - input)
typedef TIM3_CH2_PC7<kInput, GpioMode::kFloating>						TIM3_CH2_PC7_IN_CFG3;
...
typedef TIM3_CH3_PC8<kOutput50MHz, GpioMode::kAlternatePushPull>		TIM3_CH3_PC8_OUT_CFG3;
/// A default configuration to map TIM3 CH3 on PC8 pin (full remap/config 3 - input)
typedef TIM3_CH3_PC8<kInput, GpioMode::kFloating>						TIM3_CH3_PC8_IN_CFG3;
...
typedef TIM3_CH4_PC9<kOutput50MHz, GpioMode::kAlternatePushPull>		TIM3_CH4_PC9_OUT_CFG3;
/// A default configuration to map TIM3 CH4 on PC9 pin (full remap/config 3 - input)
typedef TIM3_CH4_PC9<kInput, GpioMode::kFloating>						TIM3_CH4_PC9_IN_CFG3;
...
typedef TIM4_CH1_PB6<kOutput50MHz, GpioMode::kAlternatePushPull>		TIM4_CH1_PB6_OUT;
/// A default configuration to map TIM4 CH1 on PB6 pin (input)
typedef TIM4_CH1_PB6<kInput, GpioMode::kFloating>						TIM4_CH1_PB6_IN;
...
typedef TIM4_CH2_PB7<kOutput50MHz, GpioMode::kAlternatePushPull>		TIM4_CH2_PB7_OUT;
/// A default configuration to map TIM4 CH2 on PB7 pin (input)
typedef TIM4_CH2_PB7<kInput, GpioMode::kFloating>						TIM4_CH2_PB7_IN;
...
typedef TIM4_CH3_PB8<kOutput50MHz, GpioMode::kAlternatePushPull>		TIM4_CH3_PB8_OUT;
/// A default configuration to map TIM4 CH3 on PB8 pin (input)
typedef TIM4_CH3_PB8<kInput, GpioMode::kFloating>						TIM4_CH3_PB8_IN;
...
typedef TIM4_CH4_PB9<kOutput50MHz, GpioMode::kAlternatePushPull>		TIM4_CH4_PB9_OUT;
/// A default configuration to map TIM4 CH4 on PB9 pin (input)
typedef TIM4_CH4_PB9<kInput, GpioMode::kFloating>						TIM4_CH4_PB9_IN;
...
typedef TIM4_CH1_PD12<kOutput50MHz, GpioMode::kAlternatePushPull>		TIM4_CH1_PD12_OUT;
/// A default configuration to map TIM4 CH1 on PD12 pin (input)
typedef TIM4_CH1_PD12<kInput, GpioMode::kFloating>					TIM4_CH1_PD12_IN;
...
typedef TIM4_CH2_PD13<kOutput50MHz, GpioMode::kAlternatePushPull>		TIM4_CH2_PD13_OUT;
/// A default configuration to map TIM4 CH2 on PD13 pin (input)
typedef TIM4_CH2_PD13<kInput, GpioMode::kFloating>					TIM4_CH2_PD13_IN;
...
typedef TIM4_CH3_PD14<kOutput50MHz, GpioMode::kAlternatePushPull>		TIM4_CH3_PD14_OUT;
/// A default configuration to map TIM4 CH3 on PD14 pin (input)
typedef TIM4_CH3_PD14<kInput, GpioMode::kFloating>					TIM4_CH3_PD14_IN;
...
typedef TIM4_CH4_PD15<kOutput50MHz, GpioMode::kAlternatePushPull>		TIM4_CH4_PD15_OUT;
/// A default configuration to map TIM4 CH4 on PD15 pin (input)
typedef TIM4_CH4_PD15<kInput, GpioMode::kFloating>					TIM4_CH4_PD15_IN;
...
typedef GpioTemplate<Gpio::PA, 9, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfUsart1_PA9_10>	USART1_TX_PA9;
/// A generic configuration to map USART1 RX on PA10 pin
typedef GpioTemplate<Gpio::PA, 10, kInput, GpioMode::kInputPushPull, Level::kHigh, AfUsart1_PA9_10>			USART1_RX_PA10;

//////////////////////////////////////////////////////////////////////
// USART1 - Configuration 2
//////////////////////////////////////////////////////////////////////
/// A generic configuration to map USART1 TX on PB6 pin (config 2)
typedef GpioTemplate<Gpio::PB, 6, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfUsart1_PB6_7>		USART1_TX_PB6;
/// A generic configuration to map USART1 RX on PB7 pin (config 2)
typedef GpioTemplate<Gpio::PB, 7, kInput, GpioMode::kInputPushPull, Level::kHigh, AfUsart1_PB6_7>				USART1_RX_PB7;

//////////////////////////////////////////////////////////////////////
// USART1 - Configuration 1 & 2
//////////////////////////////////////////////////////////////////////
/// A generic configuration to map USART1 CK on PA8 pin (config 1 & 2)
typedef GpioTemplate<Gpio::PA, 8, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfNoRemap>			USART1_CK_PA8;
/// A generic configuration to map USART1 CTS on PA8 pin (config 1 & 2)
typedef GpioTemplate<Gpio::PA, 11, kInput, GpioMode::kInputPushPull, Level::kHigh, AfNoRemap>					USART1_CTS_PA11;
/// A generic configuration to map USART1 RTS on PA8 pin (config 1 & 2)
typedef GpioTemplate<Gpio::PA, 12, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfNoRemap>			USART1_RTS_PA12;

//////////////////////////////////////////////////////////////////////
// USART2 - Configuration 1
//////////////////////////////////////////////////////////////////////
/// A generic configuration to map USART2 CTS on PA0 pin (config 1)
typedef GpioTemplate<Gpio::PA, 0, kInput, GpioMode::kInputPushPull, Level::kHigh, AfUsart2_PA0_1_2_3_4>			USART2_CTS_PA0;
/// A generic configuration to map USART2 RTS on PA1 pin (config 1)
typedef GpioTemplate<Gpio::PA, 1, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfUsart2_PA0_1_2_3_4>	USART2_RTS_PA1;
/// A generic configuration to map USART2 TX on PA2 pin (config 1)
typedef GpioTemplate<Gpio::PA, 2, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfUsart2_PA0_1_2_3_4>	USART2_TX_PA2;
/// A generic configuration to map USART2 RX on PA3 pin (config 1)
typedef GpioTemplate<Gpio::PA, 3, kInput, GpioMode::kInputPushPull, Level::kHigh, AfUsart2_PA0_1_2_3_4>			USART2_RX_PA3;
/// A generic configuration to map USART2 CK on PA4 pin (config 1)
typedef GpioTemplate<Gpio::PA, 4, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfUsart2_PA0_1_2_3_4>	USART2_CK_PA4;

//////////////////////////////////////////////////////////////////////
// USART2 - Configuration 2
//////////////////////////////////////////////////////////////////////
/// A generic configuration to map USART2 CTS on PD3 pin (config 2)
typedef GpioTemplate<Gpio::PD, 3, kInput, GpioMode::kInputPushPull, Level::kHigh, AfUsart2_PD3_4_5_6_7>			USART2_CTS_PD3;
/// A generic configuration to map USART2 RTS on PD4 pin (config 2)
typedef GpioTemplate<Gpio::PD, 4, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfUsart2_PD3_4_5_6_7>	USART2_RTS_PD4;
/// A generic configuration to map USART2 TX on PD5 pin (config 2)
typedef GpioTemplate<Gpio::PD, 5, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfUsart2_PD3_4_5_6_7>	USART2_TX_PD5;
/// A generic configuration to map USART2 RX on PD6 pin (config 2)
typedef GpioTemplate<Gpio::PD, 6, kInput, GpioMode::kInputPushPull, Level::kHigh, AfUsart2_PD3_4_5_6_7>			USART2_RX_PD6;
/// A generic configuration to map USART2 CK on PD7 pin (config 2)
typedef GpioTemplate<Gpio::PD, 7, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfUsart2_PD3_4_5_6_7>	USART2_CK_PD7;

//////////////////////////////////////////////////////////////////////
// USART3 - Configuration 1
//////////////////////////////////////////////////////////////////////
/// A generic configuration to map USART3 TX on PB10 pin (config 2)
typedef GpioTemplate<Gpio::PB, 10, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfUsart3_PB10_11_12_13_14> 	USART3_TX_PB10;
/// A generic configuration to map USART3 RX on PB11 pin (config 2)
typedef GpioTemplate<Gpio::PB, 11, kInput, GpioMode::kInputPushPull, Level::kHigh, AfUsart3_PB10_11_12_13_14> 				USART3_RX_PB11;
/// A generic configuration to map USART3 CK on PB12 pin (config 2)
typedef GpioTemplate<Gpio::PB, 12, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfUsart3_PB10_11_12_13_14> 	USART3_CK_PB12;

//////////////////////////////////////////////////////////////////////
// USART3 - Configuration 1 & 2
//////////////////////////////////////////////////////////////////////
/// A generic configuration to map USART3 CTS on PB13 pin (config 1 & 2)
typedef GpioTemplate<Gpio::PB, 13, kInput, GpioMode::kInputPushPull, Level::kHigh, AfUsart3_PB10_11_12_13_14> 				USART3_CTS_PB13;
/// A generic configuration to map USART3 RTS on PB14 pin (config 1 & 2)
typedef GpioTemplate<Gpio::PB, 14, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfUsart3_PB10_11_12_13_14> 	USART3_RTS_PB14;

//////////////////////////////////////////////////////////////////////
// USART3 - Configuration 2
//////////////////////////////////////////////////////////////////////
typedef GpioTemplate<Gpio::PC, 10, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfUsart3_PC10_11_12_PB13_14> 	USART3_TX_PC10;
typedef GpioTemplate<Gpio::PC, 11, kInput, GpioMode::kInputPushPull, Level::kHigh, AfUsart3_PC10_11_12_PB13_14> 			USART3_RX_PC11;
typedef GpioTemplate<Gpio::PC, 12, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfUsart3_PC10_11_12_PB13_14> 	USART3_CK_PC12;

//////////////////////////////////////////////////////////////////////
// USART3 - Configuration 3
//////////////////////////////////////////////////////////////////////
/// A generic configuration to map USART3 TX on PD8 pin (config 3)
typedef GpioTemplate<Gpio::PD, 8, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfUsart3_PD8_9_10_11_12> 	USART3_TX_PD8;
/// A generic configuration to map USART3 RX on PD9 pin (config 3)
typedef GpioTemplate<Gpio::PD, 9, kInput, GpioMode::kInputPushPull, Level::kHigh, AfUsart3_PD8_9_10_11_12> 			USART3_RX_PD9;
/// A generic configuration to map USART3 CK on PD10 pin (config 3)
typedef GpioTemplate<Gpio::PD, 10, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfUsart3_PD8_9_10_11_12> 	USART3_CK_PD10;
/// A generic configuration to map USART3 CTS on PD11 pin (config 3)
typedef GpioTemplate<Gpio::PD, 11, kInput, GpioMode::kInputPushPull, Level::kHigh, AfUsart3_PD8_9_10_11_12> 			USART3_CTS_PD11;
/// A generic configuration to map USART3 RTS on PD12 pin (config 3)
typedef GpioTemplate<Gpio::PD, 12, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfUsart3_PD8_9_10_11_12> 	USART3_RTS_PD12;

//////////////////////////////////////////////////////////////////////
// USB
//////////////////////////////////////////////////////////////////////
/// A generic configuration to map USB DM on PA11 pin
typedef GpioTemplate<Gpio::PA, 11, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfNoRemap>		USBDM;
/// A generic configuration to map USB DP on PA12 pin
typedef GpioTemplate<Gpio::PA, 12, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfNoRemap>		USBDP;

//////////////////////////////////////////////////////////////////////
// SWO
//////////////////////////////////////////////////////////////////////
/// A generic configuration to map TRACESWO on PB3 pin
typedef GpioTemplate<Gpio::PB, 3, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfNoRemap>		TRACESWO;
