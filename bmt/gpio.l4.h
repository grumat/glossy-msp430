...
**		typedef GpioTemplate<GpioPortId::PA, 5, kOutput50MHz, GpioMode::kPushPull, Level::kHigh> MY_SPI_CLK;
...
public:
	...
	static constexpr uint8_t kModerValue_ = 
		kConf_ == GpioMode::kFloating || kConf_ == GpioMode::kInputPushPull 
			? 0b00
		: kConf_ == GpioMode::kPushPull || kConf_ == GpioMode::kOpenDrain 
			? 0b01
		: kConf_ == GpioMode::kAlternatePushPull || kConf_ == GpioMode::kAlternateOpenDrain  
			? 0b10
			: 0b11
		;
	/// Constant value for MODER hardware register
	static constexpr uint32_t kModer_ = (uint32_t)kModerValue_ << (kPin << 1);
	/// Constant mask value for MODER hardware register
	static constexpr uint32_t kModerMask_ = ~(0b11UL << (kPin << 1));
	/// Constant value for OTYPER hardware register
	static constexpr uint32_t kOtyper_ = 
		kConf_ == GpioMode::kPushPull || kConf_ == GpioMode::kAlternatePushPull
			? 0
			: (1 << kPin)
		;
	/// Constant mask for OTYPER hardware register
	static constexpr uint32_t kOtyperMask_ = 
		kConf_ == GpioMode::kPushPull 
			|| kConf_ == GpioMode::kOpenDrain
			|| kConf_ == GpioMode::kAlternatePushPull
			|| kConf_ == GpioMode::kAlternateOpenDrain
			? ~(1 << kPin)
			: 0
		;
	/// Constant value for OSPEEDR hardware register (no offset)
	static constexpr uint32_t kOspeedrValue_ =
		kMode_ == GpioSpeed::kOutput50MHz ? 0b11
		: kMode_ == GpioSpeed::kOutput10MHz ? 0b10
		: kMode_ == GpioSpeed::kOutput2MHz ? 0b01
		: 0x00
		;
	/// Constant value for OSPEEDR hardware register
	static constexpr uint32_t kOspeedr_ = kOspeedrValue_ << (kPin << 1);
	/// Constant mask value for OSPEEDR hardware register
	static constexpr uint32_t kOspeedrMask_ = ~(0b11UL << (kPin << 1));
	/// Effective bit constant value
	...
	ALWAYS_INLINE static void SetupPinMode(void)
	{
		...
		port->OSPEEDR = (port->OSPEEDR & kOspeedrMask_) | kOspeedr_;
	}
	/// Apply default configuration for the pin.
...
\code{.cpp}
/// Pin for green LED
typedef GpioTemplate<GpioPortId::PA, 0, GpioSpeed::kOutput2MHzkOutput2MHz, GpioMode::kPushPull, Level::kHigh> GREEN_LED;
...
typedef GpioTemplate<GpioPortId::PA, 0, kInput, GpioMode::kAnalog> ADC12_IN0;
/// A default configuration for ADC12 IN1 on PA1
typedef GpioTemplate<GpioPortId::PA, 1, kInput, GpioMode::kAnalog> ADC12_IN1;
/// A default configuration for ADC12 IN2 on PA2
typedef GpioTemplate<GpioPortId::PA, 2, kInput, GpioMode::kAnalog> ADC12_IN2;
/// A default configuration for ADC12 IN3 on PA3
typedef GpioTemplate<GpioPortId::PA, 3, kInput, GpioMode::kAnalog> ADC12_IN3;
/// A default configuration for ADC12 IN4 on PA4
typedef GpioTemplate<GpioPortId::PA, 4, kInput, GpioMode::kAnalog> ADC12_IN4;
/// A default configuration for ADC12 IN5 on PA5
typedef GpioTemplate<GpioPortId::PA, 5, kInput, GpioMode::kAnalog> ADC12_IN5;
/// A default configuration for ADC12 IN6 on PA6
typedef GpioTemplate<GpioPortId::PA, 6, kInput, GpioMode::kAnalog> ADC12_IN6;
/// A default configuration for ADC12 IN7 on PA7
typedef GpioTemplate<GpioPortId::PA, 7, kInput, GpioMode::kAnalog> ADC12_IN7;
/// A default configuration for ADC12 IN8 on PB0
typedef GpioTemplate<GpioPortId::PB, 0, kInput, GpioMode::kAnalog> ADC12_IN8;
/// A default configuration for ADC12 IN9 on PB1
typedef GpioTemplate<GpioPortId::PB, 1, kInput, GpioMode::kAnalog> ADC12_IN9;
/// A default configuration for ADC12 IN10 on PC0
typedef GpioTemplate<GpioPortId::PC, 0, kInput, GpioMode::kAnalog> ADC12_IN10;
/// A default configuration for ADC12 IN11 on PC1
typedef GpioTemplate<GpioPortId::PC, 1, kInput, GpioMode::kAnalog> ADC12_IN11;
/// A default configuration for ADC12 IN12 on PC2
typedef GpioTemplate<GpioPortId::PC, 2, kInput, GpioMode::kAnalog> ADC12_IN12;
/// A default configuration for ADC12 IN13 on PC3
typedef GpioTemplate<GpioPortId::PC, 3, kInput, GpioMode::kAnalog> ADC12_IN13;
/// A default configuration for ADC12 IN14 on PC4
typedef GpioTemplate<GpioPortId::PC, 4, kInput, GpioMode::kAnalog> ADC12_IN14;
/// A default configuration for ADC12 IN15 on PC5
typedef GpioTemplate<GpioPortId::PC, 5, kInput, GpioMode::kAnalog> ADC12_IN15;
...
typedef GpioTemplate<GpioPortId::PA, 11, kInput, GpioMode::kInputPushPull, Level::kHigh, AfCan_PA11_12>				CAN_RX_PA11;
/// A default configuration for CAN/TX on PA12 pin
typedef GpioTemplate<GpioPortId::PA, 12, kOutput50MHz, GpioMode::kAlternateOpenDrain, Level::kLow, AfCan_PA11_12>	CAN_TX_PA12;

//////////////////////////////////////////////////////////////////////
// CAN - Configuration 2 (cannot mix pins between configuration)
//////////////////////////////////////////////////////////////////////
/// A default configuration for CAN/RX on PB8 pin
typedef GpioTemplate<GpioPortId::PB, 8, kInput, GpioMode::kInputPushPull, Level::kHigh, AfCan_PB8_9>				CAN_RX_PB8;
/// A default configuration for CAN/TX on PB9 pin
typedef GpioTemplate<GpioPortId::PB, 9, kOutput50MHz, GpioMode::kAlternateOpenDrain, Level::kLow, AfCan_PB8_9>	CAN_TX_PB9;

//////////////////////////////////////////////////////////////////////
// CAN - Configuration 3 (cannot mix pins between configuration)
//////////////////////////////////////////////////////////////////////
/// A default configuration for CAN/RX on PD0 pin
typedef GpioTemplate<GpioPortId::PD, 0, kInput, GpioMode::kInputPushPull, Level::kHigh, AfCan_PD0_1>				CAN_RX_PD0;
/// A default configuration for CAN/TX on PD1 pin
typedef GpioTemplate<GpioPortId::PD, 1, kOutput50MHz, GpioMode::kAlternateOpenDrain, Level::kLow, AfCan_PD0_1>	CAN_TX_PD1;
...
typedef GpioTemplate<GpioPortId::PB, 6, kOutput50MHz, GpioMode::kAlternateOpenDrain, Level::kLow, AfI2C1_PB6_7>	I2C1_SCL_PB6;
/// A default configuration to map I2C1 SDA on PB7 pin
typedef GpioTemplate<GpioPortId::PB, 7, kOutput50MHz, GpioMode::kAlternateOpenDrain, Level::kLow, AfI2C1_PB6_7>	I2C1_SDA_PB7;
// I2C1 - Configuration 2
/// A default configuration to map I2C1 SCL on PB8 pin
typedef GpioTemplate<GpioPortId::PB, 8, kOutput50MHz, GpioMode::kAlternateOpenDrain, Level::kLow, AfI2C1_PB8_9>	I2C1_SCL_PB8;
/// A default configuration to map I2C1 SDA on PB9 pin
typedef GpioTemplate<GpioPortId::PB, 9, kOutput50MHz, GpioMode::kAlternateOpenDrain, Level::kLow, AfI2C1_PB8_9>	I2C1_SDA_PB9;
// I2C1 - Configuration 1 & 2
/// A default configuration to map I2C1 SMBAI on PB5 pin
typedef GpioTemplate<GpioPortId::PB, 5, kOutput50MHz, GpioMode::kAlternateOpenDrain, Level::kLow, AfNoRemap>		I2C1_SMBAI_PB5;

//////////////////////////////////////////////////////////////////////
// I2C2
//////////////////////////////////////////////////////////////////////
/// A default configuration to map I2C2 SCL on PB10 pin
typedef GpioTemplate<GpioPortId::PB, 10, kOutput50MHz, GpioMode::kAlternateOpenDrain, Level::kLow, AfNoRemap>	I2C2_SCL_PB10;
/// A default configuration to map I2C2 SDA on PB11 pin
typedef GpioTemplate<GpioPortId::PB, 11, kOutput50MHz, GpioMode::kAlternateOpenDrain, Level::kLow, AfNoRemap>	I2C2_SDA_PB11;
/// A default configuration to map I2C2 SMBAI on PB12 pin
typedef GpioTemplate<GpioPortId::PB, 12, kOutput50MHz, GpioMode::kAlternateOpenDrain, Level::kLow, AfNoRemap>	I2C2_SMBAI_PB12;

//////////////////////////////////////////////////////////////////////
// SPI1 - Configuration 1
//////////////////////////////////////////////////////////////////////
/// A default configuration to map SPI1 NSS on PA4 pin (master)
typedef GpioTemplate<GpioPortId::PA, 4, kOutput50MHz, GpioMode::kAlternateOpenDrain, Level::kHigh, AfSpi1_PA4_5_6_7>	SPI1_NSS_PA4;
/// A default configuration to map SPI1 NSS on PA4 pin (slave)
typedef GpioTemplate<GpioPortId::PA, 4, kInput, GpioMode::kInputPushPull, Level::kHigh, AfSpi1_PA4_5_6_7>			SPI1_NSS_PA4_SLAVE;
/// A default configuration to map SPI1 SCK on PA5 pin
typedef GpioTemplate<GpioPortId::PA, 5, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfSpi1_PA4_5_6_7>	SPI1_SCK_PA5;
/// A default configuration to map SPI1 MISO on PA6 pin
typedef GpioTemplate<GpioPortId::PA, 6, kInput, GpioMode::kInputPushPull, Level::kHigh, AfSpi1_PA4_5_6_7>			SPI1_MISO_PA6;
/// A default configuration to map SPI1 MOSI on PA7 pin
typedef GpioTemplate<GpioPortId::PA, 7, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kHigh, AfSpi1_PA4_5_6_7>	SPI1_MOSI_PA7;
// SPI1 - Configuration 2
/// A default configuration to map SPI1 NSS on PA15 pin (master)
typedef GpioTemplate<GpioPortId::PA, 15, kOutput50MHz, GpioMode::kAlternateOpenDrain, Level::kHigh, AfSpi1_PA15_PB3_4_5>	SPI1_NSS_PA15;
/// A default configuration to map SPI1 NSS on PA15 pin (slave)
typedef GpioTemplate<GpioPortId::PA, 15, kInput, GpioMode::kInputPushPull, Level::kHigh, AfSpi1_PA15_PB3_4_5>			SPI1_NSS_PA15_SLAVE;
/// A default configuration to map SPI1 SCK on PB3 pin
typedef GpioTemplate<GpioPortId::PB, 3, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfSpi1_PA15_PB3_4_5>	SPI1_SCK_PB3;
/// A default configuration to map SPI1 MISO on PB4 pin
typedef GpioTemplate<GpioPortId::PB, 4, kInput, GpioMode::kInputPushPull, Level::kHigh, AfSpi1_PA15_PB3_4_5>				SPI1_MISO_PB4;
/// A default configuration to map SPI1 MOSI on PB5 pin
typedef GpioTemplate<GpioPortId::PB, 5, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kHigh, AfSpi1_PA15_PB3_4_5>	SPI1_MOSI_PB5;

//////////////////////////////////////////////////////////////////////
// SPI2
//////////////////////////////////////////////////////////////////////
/// A default configuration to map SPI2 NSS on PB12 pin (master)
typedef GpioTemplate<GpioPortId::PB, 12, kOutput50MHz, GpioMode::kAlternateOpenDrain, Level::kHigh, AfNoRemap>	SPI2_NSS_PB12;
/// A default configuration to map SPI2 NSS on PB12 pin (slave)
typedef GpioTemplate<GpioPortId::PB, 12, kInput, GpioMode::kInputPushPull, Level::kHigh, AfNoRemap>				SPI2_NSS_PB12_SLAVE;
/// A default configuration to map SPI2 SCK on PB13 pin
typedef GpioTemplate<GpioPortId::PB, 13, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfNoRemap>		SPI2_SCK_PB13;
/// A default configuration to map SPI2 MISO on PB14 pin
typedef GpioTemplate<GpioPortId::PB, 14, kInput, GpioMode::kInputPushPull, Level::kHigh, AfNoRemap>				SPI2_MISO_PB14;
/// A default configuration to map SPI2 MOSI on PB15 pin
typedef GpioTemplate<GpioPortId::PB, 15, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kHigh, AfNoRemap>	SPI2_MOSI_PB15;
...
typedef GpioTemplate<GpioPortId::PA, 9, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfUsart1_PA9_10>	USART1_TX_PA9;
/// A generic configuration to map USART1 RX on PA10 pin
typedef GpioTemplate<GpioPortId::PA, 10, kInput, GpioMode::kInputPushPull, Level::kHigh, AfUsart1_PA9_10>			USART1_RX_PA10;

//////////////////////////////////////////////////////////////////////
// USART1 - Configuration 2
//////////////////////////////////////////////////////////////////////
/// A generic configuration to map USART1 TX on PB6 pin (config 2)
typedef GpioTemplate<GpioPortId::PB, 6, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfUsart1_PB6_7>		USART1_TX_PB6;
/// A generic configuration to map USART1 RX on PB7 pin (config 2)
typedef GpioTemplate<GpioPortId::PB, 7, kInput, GpioMode::kInputPushPull, Level::kHigh, AfUsart1_PB6_7>				USART1_RX_PB7;

//////////////////////////////////////////////////////////////////////
// USART1 - Configuration 1 & 2
//////////////////////////////////////////////////////////////////////
/// A generic configuration to map USART1 CK on PA8 pin (config 1 & 2)
typedef GpioTemplate<GpioPortId::PA, 8, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfNoRemap>			USART1_CK_PA8;
/// A generic configuration to map USART1 CTS on PA8 pin (config 1 & 2)
typedef GpioTemplate<GpioPortId::PA, 11, kInput, GpioMode::kInputPushPull, Level::kHigh, AfNoRemap>					USART1_CTS_PA11;
/// A generic configuration to map USART1 RTS on PA8 pin (config 1 & 2)
typedef GpioTemplate<GpioPortId::PA, 12, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfNoRemap>			USART1_RTS_PA12;

//////////////////////////////////////////////////////////////////////
// USART2 - Configuration 1
//////////////////////////////////////////////////////////////////////
/// A generic configuration to map USART2 CTS on PA0 pin (config 1)
typedef GpioTemplate<GpioPortId::PA, 0, kInput, GpioMode::kInputPushPull, Level::kHigh, AfUsart2_PA0_1_2_3_4>			USART2_CTS_PA0;
/// A generic configuration to map USART2 RTS on PA1 pin (config 1)
typedef GpioTemplate<GpioPortId::PA, 1, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfUsart2_PA0_1_2_3_4>	USART2_RTS_PA1;
/// A generic configuration to map USART2 TX on PA2 pin (config 1)
typedef GpioTemplate<GpioPortId::PA, 2, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfUsart2_PA0_1_2_3_4>	USART2_TX_PA2;
/// A generic configuration to map USART2 RX on PA3 pin (config 1)
typedef GpioTemplate<GpioPortId::PA, 3, kInput, GpioMode::kInputPushPull, Level::kHigh, AfUsart2_PA0_1_2_3_4>			USART2_RX_PA3;
/// A generic configuration to map USART2 CK on PA4 pin (config 1)
typedef GpioTemplate<GpioPortId::PA, 4, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfUsart2_PA0_1_2_3_4>	USART2_CK_PA4;

//////////////////////////////////////////////////////////////////////
// USART2 - Configuration 2
//////////////////////////////////////////////////////////////////////
/// A generic configuration to map USART2 CTS on PD3 pin (config 2)
typedef GpioTemplate<GpioPortId::PD, 3, kInput, GpioMode::kInputPushPull, Level::kHigh, AfUsart2_PD3_4_5_6_7>			USART2_CTS_PD3;
/// A generic configuration to map USART2 RTS on PD4 pin (config 2)
typedef GpioTemplate<GpioPortId::PD, 4, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfUsart2_PD3_4_5_6_7>	USART2_RTS_PD4;
/// A generic configuration to map USART2 TX on PD5 pin (config 2)
typedef GpioTemplate<GpioPortId::PD, 5, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfUsart2_PD3_4_5_6_7>	USART2_TX_PD5;
/// A generic configuration to map USART2 RX on PD6 pin (config 2)
typedef GpioTemplate<GpioPortId::PD, 6, kInput, GpioMode::kInputPushPull, Level::kHigh, AfUsart2_PD3_4_5_6_7>			USART2_RX_PD6;
/// A generic configuration to map USART2 CK on PD7 pin (config 2)
typedef GpioTemplate<GpioPortId::PD, 7, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfUsart2_PD3_4_5_6_7>	USART2_CK_PD7;

//////////////////////////////////////////////////////////////////////
// USART3 - Configuration 1
//////////////////////////////////////////////////////////////////////
/// A generic configuration to map USART3 TX on PB10 pin (config 2)
typedef GpioTemplate<GpioPortId::PB, 10, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfUsart3_PB10_11_12_13_14> 	USART3_TX_PB10;
/// A generic configuration to map USART3 RX on PB11 pin (config 2)
typedef GpioTemplate<GpioPortId::PB, 11, kInput, GpioMode::kInputPushPull, Level::kHigh, AfUsart3_PB10_11_12_13_14> 				USART3_RX_PB11;
/// A generic configuration to map USART3 CK on PB12 pin (config 2)
typedef GpioTemplate<GpioPortId::PB, 12, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfUsart3_PB10_11_12_13_14> 	USART3_CK_PB12;

//////////////////////////////////////////////////////////////////////
// USART3 - Configuration 1 & 2
//////////////////////////////////////////////////////////////////////
/// A generic configuration to map USART3 CTS on PB13 pin (config 1 & 2)
typedef GpioTemplate<GpioPortId::PB, 13, kInput, GpioMode::kInputPushPull, Level::kHigh, AfUsart3_PB10_11_12_13_14> 				USART3_CTS_PB13;
/// A generic configuration to map USART3 RTS on PB14 pin (config 1 & 2)
typedef GpioTemplate<GpioPortId::PB, 14, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfUsart3_PB10_11_12_13_14> 	USART3_RTS_PB14;

//////////////////////////////////////////////////////////////////////
// USART3 - Configuration 2
//////////////////////////////////////////////////////////////////////
typedef GpioTemplate<GpioPortId::PC, 10, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfUsart3_PC10_11_12_PB13_14> 	USART3_TX_PC10;
typedef GpioTemplate<GpioPortId::PC, 11, kInput, GpioMode::kInputPushPull, Level::kHigh, AfUsart3_PC10_11_12_PB13_14> 			USART3_RX_PC11;
typedef GpioTemplate<GpioPortId::PC, 12, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfUsart3_PC10_11_12_PB13_14> 	USART3_CK_PC12;

//////////////////////////////////////////////////////////////////////
// USART3 - Configuration 3
//////////////////////////////////////////////////////////////////////
/// A generic configuration to map USART3 TX on PD8 pin (config 3)
typedef GpioTemplate<GpioPortId::PD, 8, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfUsart3_PD8_9_10_11_12> 	USART3_TX_PD8;
/// A generic configuration to map USART3 RX on PD9 pin (config 3)
typedef GpioTemplate<GpioPortId::PD, 9, kInput, GpioMode::kInputPushPull, Level::kHigh, AfUsart3_PD8_9_10_11_12> 			USART3_RX_PD9;
/// A generic configuration to map USART3 CK on PD10 pin (config 3)
typedef GpioTemplate<GpioPortId::PD, 10, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfUsart3_PD8_9_10_11_12> 	USART3_CK_PD10;
/// A generic configuration to map USART3 CTS on PD11 pin (config 3)
typedef GpioTemplate<GpioPortId::PD, 11, kInput, GpioMode::kInputPushPull, Level::kHigh, AfUsart3_PD8_9_10_11_12> 			USART3_CTS_PD11;
/// A generic configuration to map USART3 RTS on PD12 pin (config 3)
typedef GpioTemplate<GpioPortId::PD, 12, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfUsart3_PD8_9_10_11_12> 	USART3_RTS_PD12;

//////////////////////////////////////////////////////////////////////
// USB
//////////////////////////////////////////////////////////////////////
/// A generic configuration to map USB DM on PA11 pin
typedef GpioTemplate<GpioPortId::PA, 11, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfNoRemap>		USBDM;
/// A generic configuration to map USB DP on PA12 pin
typedef GpioTemplate<GpioPortId::PA, 12, kOutput50MHz, GpioMode::kAlternatePushPull, Level::kLow, AfNoRemap>		USBDP;
